...
class FotokonyvGUI:
    ...
    def create_main_menu(self):
        ...
        try:
            ...
            # Azért tároljuk self-ként, hogy a garbage collector ne törölje
            ...
            # Hiba esetén a keret megtartja az eredeti háttérszínét

        # A többi widget már a main_frame-re kerül, így a háttérkép felett jelennek meg
        ...
        button_frame.pack(expand=True, padx=40) # Megnövelt margó
    ...
    def create_layout_preview(self, parent, layout_count, click_handler=None):
        ...
        if layout_count == 1:
            ...
            cols = max(2, int(math.ceil(math.sqrt(layout_count))))
            rows = int(math.ceil(layout_count / cols))
    ...
    def show_page_selection(self, is_new_project=False):
        ...
        self.custom_card = ctk.CTkFrame(layout_frame, fg_color=self.colors['card_bg'], corner_radius=20); self.custom_card.pack(pady=(30, 20), padx=20, fill="x")
    ...
    def _define_smart_layouts(self):
        ...
        layouts = {
            ...
            '1_portrait_1_landscape_MODIFIED': {
                'priority': 5,
                'orientations': ['portrait', 'landscape'],
                'geometry': [
                    {'relx': 0.05, 'rely': 0.05, 'relwidth': 0.4, 'relheight': 0.9},
                    {'relx': 0.5, 'rely': 0.3, 'relwidth': 0.45, 'relheight': 0.4}
                ]
            },
